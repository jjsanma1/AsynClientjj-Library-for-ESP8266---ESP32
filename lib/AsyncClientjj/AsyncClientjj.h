/*
  AsyncClientjj - Library or ESP8266 and ESP32 that manages Async HTTP requests to any server (IFTTT,etc)
  It serializes requests to be sent to the server one by one. Max_Requests by default is 5 but it can be modified in the code of this class. 
